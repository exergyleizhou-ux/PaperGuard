...
This detector requires data shaped as: `image_files, claimed_timeline`.

See [`detect()` signature](../../src/paperguard/detectors/g1_exif_temporal.py) for
exact type expectations.

## Method

See implementation: [`src/paperguard/detectors/g1_exif_temporal.py`](../../src/paperguard/detectors/g1_exif_temporal.py)
...
Every finding from `G1` carries a non-exhaustive list of plausible
...
[`g1_exif_temporal.py`](../../src/paperguard/detectors/g1_exif_temporal.py).
...
标准 EXIF 取证；ORI 工具集图像审计部分。

## Source

- Implementation: [`src/paperguard/detectors/g1_exif_temporal.py`](../../src/paperguard/detectors/g1_exif_temporal.py)
