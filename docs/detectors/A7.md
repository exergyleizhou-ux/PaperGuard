# A7 — Last-Digit 0/5 Preference (Geng method)
...
See [`detect()` signature](../../src/paperguard/detectors/a7_last_digit_five_zero.py) for
exact type expectations.

## Method

See implementation: [`src/paperguard/detectors/a7_last_digit_five_zero.py`](../../src/paperguard/detectors/a7_last_digit_five_zero.py)
...
Every finding from `A7` carries a non-exhaustive list of plausible
...
[`a7_last_digit_five_zero.py`](../../src/paperguard/detectors/a7_last_digit_five_zero.py).
...
Geng Hongwei (2025) public auditing practice; Mosimann et al. (1995) Accountability in Research.

## Source

- Implementation: [`src/paperguard/detectors/a7_last_digit_five_zero.py`](../../src/paperguard/detectors/a7_last_digit_five_zero.py)
