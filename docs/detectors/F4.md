# F4 — Cross-Paper Image Duplication
...
This detector requires data shaped as: `image_files, persistent_store`.

See [`detect()` signature](../../src/paperguard/detectors/f4_cross_paper_image.py) for
exact type expectations.

## Method

See implementation: [`src/paperguard/detectors/f4_cross_paper_image.py`](../../src/paperguard/detectors/f4_cross_paper_image.py)
...
Every finding from `F4` carries a non-exhaustive list of plausible
...
[`f4_cross_paper_image.py`](../../src/paperguard/detectors/f4_cross_paper_image.py).
...
Masliah investigation (NIH 2024); Hwang affair (2005); Bik et al. (2016) cross-publication image reuse studies.

## Source

- Implementation: [`src/paperguard/detectors/f4_cross_paper_image.py`](../../src/paperguard/detectors/f4_cross_paper_image.py)
