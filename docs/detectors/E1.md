...
|---|---|
| Shipped in | 2.0.14 |
| Cluster | `arithmetic_consistency` |
| Empirical LR+ | Not yet published as a standalone study (E1 fires within the full-pipeline scans recorded in `recall_test_v5.md`) |
| First OSS implementation of Heathers 2024 ICRP | yes — to our knowledge |

## See also

- [Detector index](README.md)
- [Epistemic position](../epistemic_position.md)
- Related independence/structure detectors: [D1](D1.md) (residual smoothness), [D2](D2.md) (missing pattern)
- [Full-pipeline recall study](../recall_test_v5.md)
